 ...
 */
public class JDBCShippingStatusDAO extends JDBCAbstractDAO<ShippingStatus, Long> implements IShippingStatusDAO {
    private static final Logger logger = LoggerFactory.getLogger(JDBCShippingStatusDAO.class);
