 ...
 */
public class JDBCPaymentMethodDAO extends JDBCAbstractDAO<PaymentMethod, Long> implements IPaymentMethodDAO {
    private static final Logger logger = LoggerFactory.getLogger(JDBCPaymentMethodDAO.class);
